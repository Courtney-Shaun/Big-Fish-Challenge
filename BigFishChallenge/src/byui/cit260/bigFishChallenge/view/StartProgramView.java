...
public class StartProgramView extends View {
    ...
    private void displayBanner() {
        ...
        +"\n* Arkansas. It's time for you to cast your line   *"
        +"\n* in the water and prove that you've got what it  *"
        +"\n* takes to be a champion!                         *"
        +"\n*                                                 *"
        +"\n* You will need to buy bait and fuel and get out  *"
        ...
        +"\n* to look for other fishermen, who can give you   *"
